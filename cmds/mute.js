        ...
        if (durationInMinutes !== undefined && durationInMinutes > 0) {
            ...
            setTimeout(async () => {
                try {
                    ...
                    await sock.sendMessage(chatId, { text: 'The group has been unmuted by blue lock xmd.' });
                } catch (unmuteError) {
                    console.error('Error unmuting group:', unmuteError);
                }
            }, durationInMilliseconds);
        } else {
            await sock.sendMessage(chatId, { text: 'The group has been muted by blue lock xmd.' }, { quoted: message });
        }
    } catch (error) {

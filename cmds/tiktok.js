        ...
        try {
                        ...
                        for (let i = 0; i < Math.min(20, mediaData.length); i++) {
                            ...
                            if (isVideo) {
                                await sock.sendMessage(chatId, {
                                    video: { url: mediaUrl },
                                    mimetype: "video/mp4",
                                    caption: "𝐌𝐄𝐃𝐈𝐀 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐃 𝐁𝐘 𝐁.𝐋.𝐗𝐌𝐃"
                                }, { quoted: message });
                            } else {
                                await sock.sendMessage(chatId, {
                                    image: { url: mediaUrl },
            ...
            if (videoUrl) {
                try {
                    ...
                    const caption = title ? `𝐌𝐄𝐃𝐈𝐀 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐃 𝐁𝐘 𝐁.𝐋.𝐗𝐌𝐃\n\n📝 𝗧𝗶𝘁𝗹𝗲: ${title}` : "𝐌𝐄𝐃𝐈𝐀 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐃 𝐁𝐘 𝐁.𝐋.𝐗𝐌𝐃";
                    ...
                    try {
                        const caption = title ? `𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐃 𝐁𝐘 𝐁.𝐋.𝐗𝐌𝐃\n\n📝 𝗧𝗶𝘁𝗹𝗲: ${title}` : "𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐃 𝐁𝐘 𝐁.𝐋.𝐗𝐌𝐃";
